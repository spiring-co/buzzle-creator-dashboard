          ...
          <TabPanel value={activeTabIndex} index={3}>
            <Box display="flex" flexDirection="column" px={8}>
              <FormControl>
                ...
                <Select
                  defaultValue={job.renderPrefs.settingsTemplate || ""}
              ...
              <FormControl>
                ...
                <Select
                  defaultValue={job.renderPrefs.outputModule || ""}
                  value={values.outputModule}
                  onChange={handleChange}
                  name="outputModule"
                  inputProps={{
                    name: "outputModule",
              ...
              <TextField
                defaultValue={job.renderPrefs.incrementFrame || ""}
              ...
              />
              <TextField
                defaultValue={job.renderPrefs.frameStart || ""}
                onChange={handleChange}
              ...
              />
              <TextField
                defaultValue={job.renderPrefs.frameEnd || ""}
                onChange={handleChange}
